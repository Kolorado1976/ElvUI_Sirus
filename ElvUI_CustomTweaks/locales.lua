...
if L then
	...
	L["Nameplate Tweaks"] = "Твики индикаторов здоровья";
	L["Отображает индикатор уровня угрозы на неймлейтах."] = "Отображает индикатор уровня угрозы на неймлейтах.";
	L["Nameplate Threat"] = "Угроза на неймлейтах";
	L["Enable Threat Indicator"] = "Включить индикатор угрозы";
	L["Threat Color"] = "Цвет угрозы";
