...
L["MSG_QUESTACHDB_BUILT"] = "База данных связей квестов и достижений построена."
L["MSG_QUESTACHDB_OUTDATED"] = "База данных связей устарела. Используйте /oarebuild для обновления."
L["MSG_REBUILDING_QUESTACHDB"] = "Перестраиваю базу данных связей квестов и достижений..."
L["MSG_QUESTACHMODULE_LOADED"] = "Модуль связи квестов и достижений загружен."
L["MSG_QUESTACHMODULE_READY"] = "Модуль связи квестов и достижений готов к работе."
L["MSG_QUESTACHMODULE_DISABLED"] = "Модуль связи квестов и достижений отключен в настройках."
L["MSG_QUESTACHDB_LOADED"] = "База данных загружена. %d связей квест-достижение."
L["MSG_QUESTACHDB_FIRSTLOAD"] = "Первая загрузка. Строю базу данных связей..."
L["MSG_QUESTACHDB_USAGE"] = "Используйте /oarebuild для перестроения базы данных."
L["MSG_BUILDING_QUESTACHDB"] = "Строю базу данных связей квестов и достижений..."
L["MSG_BUILD_PROGRESS"] = "Обработано %d/%d достижений"
L["MSG_GETACH_FAILED"] = "Не удалось получить список достижений"
L["QUEST_RELATED_ACHIEVEMENTS"] = "Связанные достижения:"
L["QUEST_ACHIEVEMENT_HINT"] = "Этот квест требуется для завершения указанных достижений."
L["ACH_LOREMASTER_EASTERN"] = "Loremaster of Eastern Kingdoms"
L["ACH_LOREMASTER_KALIMDOR"] = "Loremaster of Kalimdor"
L["OPT_QUESTACHIEVEMENTTIPS"] = "Показывать связанные достижения в подсказках квестов"
L["OPT_QUESTACHIEVEMENTTIPS_TIP"] = "Показывать в подсказках к квестам информацию о достижениях, для которых требуется этот квест."
L["OPT_LABEL_QUESTACH"] = "Связи квестов и достижений"
L["OPT_QUESTACHIEVEMENTTIPS"] = "Включить связь квестов и достижений"
L["OPT_QUESTACHIEVEMENTTIPS_TIP"] = "Показывать связанные достижения при принятии квестов"
L["OPT_SHOWPOPUPALERTS"] = "Всплывающие уведомления"
L["OPT_SHOWPOPUPALERTS_TIP"] = "Показывать всплывающие окна при обнаружении связанных достижений"
L["OPT_CHATMESSAGES"] = "Сообщения в чате"
L["OPT_CHATMESSAGES_TIP"] = "Показывать информацию о связанных достижениях в чате"
L["OPT_QUIETMODE"] = "Тихий режим"
L["OPT_QUIETMODE_TIP"] = "Показывать только квесты, у которых есть связанные достижения"
L["OPT_DEBUGMODE"] = "Режим отладки"
L["OPT_DEBUGMODE_TIP"] = "Включить подробное логгирование для отладки"
