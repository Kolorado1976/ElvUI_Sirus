...
function Overachiever.CreateOptions(THIS_TITLE, BuildCriteriaLookupTab_check, AutoTrackCheck_Explore, CheckDraggable_AchFrame)
  ...
  local items_general = {
	...
	{ type = "labelwrap", text = L.OPT_LABEL_QUESTACH, topBuffer = 4 },
	{ variable = "QuestAchievementTips", text = L.OPT_QUESTACHIEVEMENTTIPS, 
	  tooltip = L.OPT_QUESTACHIEVEMENTTIPS_TIP },
	{ variable = "ShowPopupAlerts", text = L.OPT_SHOWPOPUPALERTS, 
	  tooltip = L.OPT_SHOWPOPUPALERTS_TIP },
	{ variable = "ChatMessages", text = L.OPT_CHATMESSAGES, 
	  tooltip = L.OPT_CHATMESSAGES_TIP },
	{ variable = "QuietMode", text = L.OPT_QUIETMODE, 
	  tooltip = L.OPT_QUIETMODE_TIP },
	{ variable = "DebugMode", text = L.OPT_DEBUGMODE, 
	  tooltip = L.OPT_DEBUGMODE_TIP },
  }
